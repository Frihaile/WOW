 ...
 <html lang="en" dir="ltr">
     ...
     *{box-sizing:border-box;}
     ...
     :root {
        ...
        .book-cover {
            ...
            position: absolute;
            background-image: linear-gradient(to bottom, #D8BFD8,#D8BFD8);
  ...
  <body class="body">
    ...
    <div>
      ...
      <div id="book">
          <div class="book-cover one-page"><img src="img/lipstick10.jpg"></div>

          <div class="book-page one-page"><img src="img/lipstick1.jpg"></div>
          <div class="book-page one-page"><img src="img/lipstick2.jpg"></div>
          <div class="book-page one-page"><img src="img/lipstick3.jpg"></div>
          <div class="book-page one-page"><img src="img/lipstick4.jpg"></div>
          <div class="book-page one-page"><img src="img/lipstick5.jpg"></div>
          <div class="book-page one-page"><img src="img/lipstick6.jpg"></div>
          <div class="book-page one-page"><img src="img/lipstick7.jpg"></div>
          <div class="book-page one-page"><img src="img/lipstick8.jpg"></div>
          <div class="book-page one-page"><img src="img/lipstick9.jpg"></div>
          <div class="book-page one-page"><img src="img/lipstick10.jpg"></div>
      ...
      <script>
          ...
          function init() {
              ...
              // 默认页面为封面，左按钮无效
              btn[0].style.backgroundColor = "rgba(110, 100, 100, 0.3)"
        ...
        <div class="boxnav"><em>
            <span>Synopsis:</span>
            <span>Ouya,the author's biography is unknown.</span>
